...
async def start_cmd(msg: types.Message):
    ...
    url_button1 = InlineKeyboardButton(text='Тест', url='https://myfreedom.by/test/proforientation?ysclid=lb7jqorfrw354729508')
    inline_button1.add(url_button1)
    await msg.answer('Так же вы можете пройти тест нажав на кнопку <Тест>', reply_markup=inline_button1)
    ...
    if msg.text == 'Карьерные карты':
        ...
        async def process_callback_kb1btn1(callback_query: types.CallbackQuery):
            ...
            if code.isdigit():
                code = int(code)
            if code == 1:
                await bot.send_message(chat_id=mess, text='<strong>Мобильная разработка</strong>,'
                ...
                await bot.send_message(chat_id=mess, text="Карьерный рост", reply_markup=key)
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(callback_query1.from_user.id, "З/П — 30 000 - 60 000 ₽/мес"
                        ...
                        await bot.send_message(callback_query1.from_user.id, "З/П — 60 000 - 150 000 ₽/мес"
                        ...
                        await bot.send_message(callback_query1.from_user.id, "З/П — 150 000 – 250 000 ₽/мес"
                        ...
                        await bot.send_message(callback_query1.from_user.id, "З/П — 250 000 – 400 000 ₽/мес"
            ...
            if code == 2:
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="З/П — 30 000 - 60 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 2 года"
                                                                            "\nЭто специалист, обладающий теоретическими знаниями разработки. "
                                                                            "Часто – понимает основы алгоритмизации и основные структуры данных, "
                                                                            "возможности выбранного языка программирования и 1-2 фреймворков. "
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 60 000 - 150 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 2 / 4 года"
                                                                            "\nОпытный разработчик уже не требует сильного контроля со стороны старших и способен сам определять направление и метод реализации задач, "
                                                                            "которые ему ставит начальник. Он понимает процессы в команде, архитектуру продукта, продуктовый контекст и почему все так, "
                                                                            "а не иначе. Успешно решает задачи средней сложности длиной в неделю и более.")
                    elif code1 == ":":
                        await bot.send_message(chat_id=mess, text="З/П — 150 000 – 250 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 5 лет"
                                                                            "\nРуководитель (TeamLead) знает несколько языков программирования, "
                                                                            "может с нуля реализовать архитектуру проекта, выбрать стек технологий. "
                                                                            "При решении поставленных задач видит общую картину, не привязывается к каким-то конкретным технологиям, "
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 250 000 – 400 000 ₽/мес"
                                                                            "\nCIO (Chief Information Officer), или ИТ-директор — это топ-менеджер,  "
                                                                            "который отвечает за информационные технологии (ИТ), "
                                                                            "особенно в ИТ-компаниях или компаниях, деятельность которых преимущественно базируется на ИТ-инфраструктуре."
                                                                            "Роль CIO в компании состоит в разработке информационной стратегии по управлению бизнесом на основе передовых цифровых технологий, "
            ...
            if code == 3:
                await bot.send_message(chat_id=mess, text='Дословно data science — наука о данных. '
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code2.isdigit():
                        code2 = int(code2)
                    if code2 == "*":
                        await bot.send_message(chat_id=mess, text="З/П — 60 000 - 80 000 ₽/мес"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 180 000 - 250 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 5 лет"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 250 000 – 500 000 ₽/мес"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 400 000 – 800 000 ₽/мес"
            ...
            if code == 4:
                await bot.send_message(chat_id=mess, text='Frontend-разработка — это создание внешнего интерфейса web-сайта или другого программного продукта.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1 == "*":
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 250 000 – 400 000 ₽/мес"
                                                                            ...
                                                                            "(например, использования аутсорсинга вместо труда собственных сотрудников).")
            if code == 5:
                await bot.send_message(chat_id=mess, text='IT-архитектор — это специалист, который решает, как в конечном итоге будет выглядеть информационная система компании.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="З/П — 40 000 - 60 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 3 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 100 000 - 150 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 5 лет"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 180 000 – 300 000 ₽/мес"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 300 000 – 1 000 000 ₽/мес"
            ...
            if code == 6:
                await bot.send_message(chat_id=mess, text='IT-консалтинг — один из множества видов консалтинга на рынке.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="З/П — 40 000 - 70 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 2 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 120 000 - 200 000 ₽/мес"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 200 000 – 400 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 6 лет"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 500 000 – 1 500 000 ₽/мес"
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1 == "*":
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 250 000 – 400 000 ₽/мес"
                                                                            ...
                                                                            "(например, использования аутсорсинга вместо труда собственных сотрудников).")
            if code == 8:
                await bot.send_message(chat_id=mess, text='UX-дизайн — это проектирование интерфейса на основе исследования пользовательского опыта и поведения.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1 == "*":
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 80 000 - 180 000 ₽/мес"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 250 000 – 600 000 ₽/мес"
            ...
            if code == 9:
                await bot.send_message(chat_id=mess, text='Бизнес-аналитика — это вид аналитики, основная задача которого — выявлять проблемы бизнеса (узкие горлышки в процессах,операциях, структуре) и предлагать их решение.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="З/П — 50 000 - 90 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 2 года"
                    ...
                    if code1 == ";":
                        await bot.send_message(chat_id=mess, text="З/П — 90 000 - 180 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 2 / 3 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 300 000 – 700 000 ₽/мес"
            ...
            if code == '!':
                await bot.send_message(chat_id=mess, text='Геймдизайн — это не столько вид традиционного дизайна, сколько управление процессом создания игры: в чем будет заключаться сюжет игры, какой набор действий будет предлагаться игроку,'
            ...
            if code == '&':
                await bot.send_message(chat_id=mess, text='Digital-маркетинг — это комплекс мероприятий и инструментов, нацеленных на продвижение продукта или услуги в интернете.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1 == ";":
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 300 000 – 1 500 000 ₽/мес"
            ...
            if code == '^':
                await bot.send_message(chat_id=mess, text='AR/VR-разработчик — это программист,  который разрабатывает приложения виртуальной и дополненной реальности.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1 == "*":
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 60 000 - 140 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 2 / 3 года"
                                                                            "\nОпытный разработчик уже не требует сильного контроля со стороны старших и способен сам определять направление и метод реализации задач, "
                                                                            "которые ему ставит начальник. Он понимает процессы в команде, архитектуру продукта, продуктовый контекст и почему все так, "
                                                                            "а не иначе. Успешно решает задачи средней сложности длиной в неделю и более.")
            ...
            if code == '_':
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="З/П — 50 000 - 80 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 3 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 90 000 - 200 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 5 лет"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 300 000 – 600 000 ₽/мес"
            ...
            if code == '-':
                await bot.send_message(chat_id=mess, text="Product менеджмент — это полный цикл создания продукта от появления идеи до его продвижения на рынке."
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="60 000 – 80 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 3 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 500 000 – 2 000 000 ₽/мес"
            ...
            if code == '+':
                await bot.send_message(chat_id=mess, text='Направление внутри компании, которое занимается разработкой и внедрением новых технологий в механизмы и бизнес-процессы корпорации.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="50 000 – 90 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 2 года"
            ...
            if code == '~':
                await bot.send_message(chat_id=mess, text='Системное администрирование — направление в IT, которое обеспечивает работу компьютерной техники, сети и программного обеспечения в организации, а также совместно с подразделением кибер-безопасности отвечает за информационную безопасность компании.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="30 000 – 50 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 2 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 60 000 - 120 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 4 года"
            ...
            if code == '№':
                await bot.send_message(chat_id=mess, text='Project менеджер организует работу всей  команды таким образом, что у каждого есть понимание того, как, к какому моменту и какая задача должна быть выполнена.'
                ...
                async def process_callback_kb1btn2(callback_query1: types.CallbackQuery):
                    ...
                    if code1.isdigit():
                        code1 = int(code1)
                    if code1 == "*":
                        await bot.send_message(chat_id=mess, text="50 000 – 80 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 1 / 2 года"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 110 000 - 180 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 2 / 5 лет"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 190 000 – 270 000 ₽/мес"
                                                                            "\nРаботает на-позиции — 3 / 6 лет"
                        ...
                        await bot.send_message(chat_id=mess, text="З/П — 280 000 – 350 000 ₽/мес"
